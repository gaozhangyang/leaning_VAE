...
if __name__ =='__main__':
    ...
    # training for 1 epoch
        globalstep=train(modelS, optimizerS,epoch,globalstep,'Hyper-spherical VAE ',device)
        torch.save(modelS.state_dict(),'./result2d/Hsphere_epoch{}_step{}.pkl'.format(epoch,globalstep))
        with torch.no_grad():
